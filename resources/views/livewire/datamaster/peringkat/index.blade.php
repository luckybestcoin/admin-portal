            ...
            <div class="col-sm-12">
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <a href="{{ route('datamaster.peringkat.tambah') }}" class="btn btn-primary">Tambah Data</a>
                        @endrole
                            ...
                            <table class="table table-framed">
                                ...
                                @foreach ($data as $i => $row)
                                    <tr>
                                        ...
                                        <td class="align-middle">{{ $row->peringkat_nama }}</td>
                                        <td class="align-middle">{{ number_format($row->peringkat_omset_min, 2) }}</td>
                                        <td class="align-middle">{{ number_format($row->peringkat_bonus, 2) }}</td>
                                                ...
                                                @else
                                                    ...
                                                    @else
                                                        ...
                                                        <div class="dropdown-menu" >
                                                            <a class="dropdown-item waves-effect waves-light" href="{{ route('datamaster.peringkat.edit', [ 'key' => $row->getKey() ]) }}">Edit</a>
                                                        </div>
                                                    @endif
                                                @endif
                                            </div>
